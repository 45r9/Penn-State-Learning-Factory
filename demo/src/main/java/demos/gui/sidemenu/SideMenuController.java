...
public class SideMenuController {
    ...
    @FXML
    @ActionTrigger("homePage")
    private Label homePage;
    @FXML
    @ActionTrigger("threeDPrinter")
    private Label threeDPrinter;
    @FXML
    @ActionTrigger("Rfid")
    private Label rfid;
    @FXML
    ...
    public void init() {
        ...
        bindNodeToController(homePage, HomePageController.class, contentFlow, contentFlowHandler);
        bindNodeToController(threeDPrinter, ThreeDPrinterController.class, contentFlow, contentFlowHandler);
        bindNodeToController(rfid, RfidController.class, contentFlow, contentFlowHandler);
